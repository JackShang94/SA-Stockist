...
@ComponentScan(basePackages="com.sa45.team3")
@PropertySource({ "classpath:application.properties",
		"classpath:/i18n/messages.properties" })
@EnableJpaRepositories("com.sa45.team3.repository")
public class WebAppConfig extends WebMvcConfigurerAdapter {

	private static final String PROPERTY_NAME_DATABASE_DRIVER = "db.driver"; //comes from application config file
	...
	public ViewResolver viewResolver() {
		...
		viewResolver.setPrefix("/WEB-INF/views/"); //all pages will be in this folder
		viewResolver.setSuffix(".jsp"); //all the suffix will be jsp
		return viewResolver;
	}
